...
export const herramientas: Herramienta[] = [
  ...
  },
  {
    ...
    guiaDescarga: {
      titulo: "Cómo obtener el reporte en Mercado Pago",
      pasos: [
        "Ingresá a Mercado Pago desde la computadora con tu cuenta de vendedor.",
        "Entrá a Reportes → “Cerrar y conciliar mes” → “Todas las transacciones”.",
        "Elegí el período que querés analizar, filtrá y creá el reporte en formato .xlsx.",
        "Mercado Pago tarda un rato en generarlo: esperá a que aparezca como listo y descargalo. Ese archivo es el que subís acá, tal cual, sin abrirlo ni modificarlo.",
      ],
      nota: "Usá ese reporte y no el de “Cobros”: comprobamos con una cuenta real que el de Cobros puede dejar afuera buena parte de lo cobrado (en ese caso, todos los pagos con dinero en cuenta de Mercado Pago, el 57 % de la facturación). El de “Todas las transacciones” trae todo, y comparado día por día contra la planilla de un local coincidió al peso en 19 de 21 días. Igual aceptamos los dos formatos: si subís el de Cobros, te avisamos.",
    },
    pasos: [
      "Arrastrá el reporte al recuadro (podés sumar varios meses; si se solapan, cada operación se cuenta una sola vez).",
      "Elegí la hora de corte del turno (con 06:00, un cobro de las 02:30 del sábado cuenta para el viernes; con 00:00 usás el día calendario, que es lo que sirve para comparar contra la planilla del local) y dejá marcada la opción de contar las transferencias recibidas como cobros si tus clientes te pagan por alias o CVU.",
